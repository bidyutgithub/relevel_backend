...
const {createCategory,getAllCategory,getAllCategoryOnId,updateCategory,deleteCategory}=require('../controller/category')
...
routes.get('/ecomm/api/v1/categories/:id',getAllCategoryOnId)
